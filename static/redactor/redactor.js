...
(function($)
{
	...
	$.Redactor.opts = {
			...
			buttonsCustom: {},
			buttonsAdd: [],
			buttons: ['html', '|', 'formatting', '|', 'bold', 'italic', 'underline', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'image', 'table', 'link', '|', 'horizontalrule'], // 'alignement', underline', 'alignleft', 'aligncenter', 'alignright', 'justify'
			...
			formattingTags: ['p', 'blockquote', 'h3', 'h4', 'h5', 'h6'],
